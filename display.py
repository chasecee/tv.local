...
class DisplayPlayer:
    ...
    def _display_image(self, image_path):
        ...
        try:
            # logging.debug(f"Displaying image: {image_path}") # Very verbose
    ...
    def _playback_loop(self):
        ...
        while not self._stop_event.is_set():
            ...
            # logging.debug("Playback loop: Processing flag is False, attempting playback.")
            ...
            # logging.debug(f"Playback loop: Found {len(frames)} frames. Starting loop cycle.")
            for frame_path in frames:
                ...
                #else:
                #    logging.warning(f"Playback loop: Frame display took too long ({elapsed_time:.3f}s), skipping sleep.")
